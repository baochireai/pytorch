...
def get_annotation_str(annotation):
    ...
    if isinstance(annotation, ast.Name):
        ...
        subscript_slice=annotation.slice if sys.version_info >= (3, 9) else annotation.slice.value
        return f"{get_annotation_str(annotation.value)}[{get_annotation_str(subscript_slice)}]"  # type: ignore
